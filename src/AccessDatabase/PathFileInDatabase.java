...
public interface PathFileInDatabase {
    ...
    // Personnel
    public final String PathPersonnelAccounts = "";
    public final String PathPersonnelInformation = "";

    // Users
    public final String PathUsersAccounts = "";
    public final String PathUsersInformation = "";

    //
    public final String PathAllAccountsID = "";
}
